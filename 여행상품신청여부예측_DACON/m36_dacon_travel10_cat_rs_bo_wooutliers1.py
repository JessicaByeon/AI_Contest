...
x_train,x_test,y_train,y_test = train_test_split(
  x, y, train_size=0.9, shuffle=True, random_state=1234, stratify=y)
...
submission.to_csv(path + 'sample_submission_70_04.csv', index=False)
...
# 70_03 이상치 제거(기본 25%)
# 최적의 매개변수 :  {'od_pval': 0.236844398775451, 'model_size_reg': 0.30614059763442997, 'learning_rate': 0.20909079092170735, 'l2_leaf_reg': 5.535171839105427, 'depth': 8}        
# 최상의 점수 :  0.9123119331452666 --- 0.8976982097
# acc : 0.9545454545454546

# 70_04 이상치 제거 없이
# train_size=0.91
# 최적의 매개변수 :  {'od_pval': 0.236844398775451, 'model_size_reg': 0.30614059763442997, 'learning_rate': 0.20909079092170735, 'l2_leaf_reg': 5.535171839105427, 'depth': 8}        
# 최상의 점수 :  0.9123119331452666 --- 0.9079283887
# acc : 0.9545454545454546

# train_size=0.90
# 최적의 매개변수 :  {'od_pval': 0.236844398775451, 'model_size_reg': 0.30614059763442997, 'learning_rate': 0.20909079092170735, 'l2_leaf_reg': 5.535171839105427, 'depth': 8}        
# 최상의 점수 :  0.9084863752099245
