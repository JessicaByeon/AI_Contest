...
# 6/ MaritalStatus 컬럼 삭제 --- 삭제하면 성능이 떨어져 삭제하지 않음
# train_set = train_set.drop(['MaritalStatus'], axis=1)
# test_set = test_set.drop(['MaritalStatus'], axis=1)

# 7/ MonthlyIncome (Designation별 평균으로 변경)
...
median_cols = ['NumberOfFollowups', 'PreferredPropertyStar', 'NumberOfTrips',
...
#                             'Age', 'OwnCar', 'MonthlyIncome', 'NumberOfTrips', 'NumberOfFollowups'], axis=1)
# train_set = train_set.drop(['TypeofContact', 'NumberOfChildrenVisiting',
#                             'OwnCar','MonthlyIncome', 'NumberOfTrips', 'NumberOfFollowups'], axis=1)
# test_set = test_set.drop(['TypeofContact', 'NumberOfChildrenVisiting',
#                             'OwnCar','MonthlyIncome', 'NumberOfTrips', 'NumberOfFollowups'], axis=1)
train_set = train_set.drop(['Age','OwnCar','MonthlyIncome'], axis=1)
test_set = test_set.drop(['Age','OwnCar','MonthlyIncome'], axis=1)
...
submission.to_csv(path + 'sample_submission_23_01.csv', index=True)
